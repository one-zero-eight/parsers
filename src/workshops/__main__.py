...
from src.workshops.parser import WorkshopParser
import re
...
if __name__ == "__main__":
    ...
    calendars_data["workshops"] = [
        {
            ...
            "timeslots": [
                {"start": timeslot[0].isoformat(), "end": timeslot[1].isoformat()} for timeslot in workshop.timeslots
            ],
    ...
    for workshop_event in events:
        ...
        workshop_calendar["x-wr-calname"] = f"Bootcamp {config.YEAR_OF_BOOTCAMP} workshop: {workshop_event.summary}"
